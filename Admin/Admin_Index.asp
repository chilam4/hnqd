...
function ChangeSideBarState(temp) {
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="3"><div id="content">
          <ul id="ChannelMenuItems">
            ...
            <li id="Talent" onClick="ShowHideLayer('ChannelMenu_Talent')"><a href="javascript:" id="AChannelMenu_Talent" onClick="ShowMain('Admin_Index_Left.Asp?ID=Talent','')"><span id="SpanChannelMenu_Talent">招贤纳士</span></a></li>
            ...
            <li id="Plug" onClick="ShowHideLayer('ChannelMenu_Plug')"><a href="javascript:" id="AChannelMenu_Plug" onClick="ShowMain('Admin_Index_Left.Asp?ID=Plug','')"><span id="SpanChannelMenu_Plug">插件</span></a></li>
            <!--
            ...
            <li id="Promotion" onClick="ShowHideLayer('ChannelMenu_Promotion')"><a href="javascript:" id="AChannelMenu_Promotion" onClick="ShowMain('Admin_Index_Left.Asp?ID=Promotion','')"><span id="SpanChannelMenu_Promotion">推广</span></a></li> -->
          </ul>
          <div id="SubMenu">
          ...
          <div id="Announce"><a href="../../" target="_blank"><img src="Images/Home.gif" width="37" height="14" border="0" alt="前台首页" /></a> <a href="http://www.qianbo.com.cn/" target="_blank"><img src="Images/Help.gif" width="37" height="14" border="0" alt="技术支持：网络" /></a> <a href="javascript:AdminOut()"><img src="Images/Exit.gif" width="37" height="14" border="0" alt="安全退出" /></a></div>
        </div></td>
    </tr>
    <tr style="vertical-align: top;">
      ...
      <td onClick="switchSysBar();" class="but"><img id="switchPoint" src="images/butClose.gif" alt="关闭左栏" style="border: 0px; width: 12px;" /></td>
      <td>
